...
export default function Create({ auth, sites, roles }: PageProps<{ sites: Site[]; roles: { value: UserRole; label: string }[] }>) { return <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-foreground">Create User</h2>}><Head title="Create User" /><div className="py-10"><div className="mx-auto max-w-4xl sm:px-6 lg:px-8"><Form sites={sites} roles={roles} /></div></div></AuthenticatedLayout>; }
