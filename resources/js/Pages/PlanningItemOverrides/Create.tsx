...
export default function Create({ planningItems, vehicleCategories }: PageProps<{ planningItems: PlanningItem[]; vehicleCategories: VehicleCategoryOption[] }>) { return <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-foreground">Create Interval Override</h2>}><Head title="Create Interval Override" /><div className="py-10"><div className="mx-auto max-w-3xl sm:px-6 lg:px-8"><Form planningItems={planningItems} vehicleCategories={vehicleCategories} /></div></div></AuthenticatedLayout>; }
