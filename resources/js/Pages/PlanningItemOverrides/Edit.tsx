...
export default function Edit({ override, planningItems, vehicleCategories }: PageProps<{ override: PlanningItemOverride; planningItems: PlanningItem[]; vehicleCategories: VehicleCategoryOption[] }>) { return <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-foreground">Edit Pengecualian Interval</h2>}><Head title="Edit Pengecualian Interval" /><div className="py-10"><div className="mx-auto max-w-3xl sm:px-6 lg:px-8"><Form override={override} planningItems={planningItems} vehicleCategories={vehicleCategories} /></div></div></AuthenticatedLayout>; }
