...
class WorkOrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'active_item_breakdown' => $this->when(isset($this->active_item_breakdown), $this->active_item_breakdown),
            'blocked_items_count' => $this->when(isset($this->blocked_items_count), (int) $this->blocked_items_count),
            'is_direct_completion_ready' => $this->when(isset($this->is_direct_completion_ready), (bool) $this->is_direct_completion_ready),
            'baseline_incomplete_items_count' => $this->when(isset($this->baseline_incomplete_items_count), (int) $this->baseline_incomplete_items_count),
            'overdue_items_count' => $this->when(isset($this->overdue_items_count), (int) $this->overdue_items_count),
            'rejected_items_count' => $this->when(isset($this->rejected_items_count), (int) $this->rejected_items_count),
            ...
            'has_priority_items' => $this->when(isset($this->has_priority_items), (bool) $this->has_priority_items),
